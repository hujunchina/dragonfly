<template>
	<div class="container">
		...
		<el-button
			...
			v-has3="'/industrymanage/tongtianManage/outTransCode/add'"
		>
			添加
		</el-button>
		...
		>
			...
			<el-table-column prop="outTransCode" label="外部交易编码"></el-table-column>
			<el-table-column prop="outTransCodeName" label="外部交易名称"></el-table-column>
			<el-table-column prop="outRouterType" label="外部交互方式" sortable></el-table-column>
			...
			<el-table-column fixed="right" label="操作" width="170">
				<template slot-scope="scope">
					...
					<el-button
						...
						circle
						size="small"
						v-has3="'/industrymanage/tongtianManage/outTransCode/publish'"
					></el-button>
					<el-button
					...
					<el-button
						...
						circle
						size="small"
						v-has3="'/industrymanage/tongtianManage/outTransCode/update'"
					></el-button>
				</template>
			</el-table-column>
		</el-table>
		...
		>
			<div>
				...
				>
					...
					<el-form-item label-width="30%" label="外部交易编码" prop="outTransCode">
						<el-input
							autosize
							type="textarea"
							v-model="uriRuleAddContent.outTransCode"
							auto-complete="off"
						></el-input>
					</el-form-item>
					<el-form-item label-width="30%" label="外部交易名称" prop="outTransCodeName">
						<el-input
							autosize
							type="textarea"
							v-model="uriRuleAddContent.outTransCodeName"
							auto-complete="off"
						></el-input>
					</el-form-item>
					<el-form-item label-width="30%" label="外部交互方式" prop="outRouterType">
						<el-input
							autosize
							type="textarea"
							v-model="uriRuleAddContent.outRouterType"
							auto-complete="off"
						></el-input>
					</el-form-item>
				...
				>
					...
					<el-form-item label-width="30%" label="外部交易编码" prop="outTransCode">
						<el-input
							autosize
							type="textarea"
							v-model="uriRuleUpdateContent.outTransCode"
							auto-complete="off"
						></el-input>
					</el-form-item>
					<el-form-item label-width="30%" label="外部交易名称" prop="outTransCodeName">
						<el-input
							autosize
							type="textarea"
							v-model="uriRuleUpdateContent.outTransCodeName"
							auto-complete="off"
						></el-input>
					</el-form-item>
					<el-form-item label-width="30%" label="外部交互方式" prop="outRouterType">
						<el-input
							autosize
							type="textarea"
							v-model="uriRuleUpdateContent.outRouterType"
							auto-complete="off"
						></el-input>
						<el-form-item label-width="30%" label="备注" prop="memo">
							<el-input
...
export default {
	data() {
		return {
			...
			rules: {
				...
				outTransCode: [{ required: true, message: '请输入外部交易编码', trigger: 'blur' }],
				outTransCodeName: [{ required: true, message: '请输入外部交易名称', trigger: 'blur' }],
				outRouterType: [{ required: true, message: '请输入外部交互方式', trigger: 'blur' }],
			},
			...
			res_application: [
				{
					value: 'smart',
					url: 'com.tuya.atop.client.service.auth.IAuthAtopService',
				},
				{
					value: 'apollo',
					url: 'com.tuya.apollo.atop.auth.IApolloAuthAtopService',
				},
			],
	...
	methods: {
		...
		loadData: function () {
			...
			let outTransCode = null;
			let outTransCodeName = null;
			let outRouterType = null;
			let modifier = null;
			let creator = null;
			...
			this.searchList.forEach((it) => {
				switch (it.searchType) {
					...
					case 'outTransCodeId':
						...
						break;
					case 'outTransCode':
						outTransCode = it.searchInput;
						break;
					case 'outTransCodeName':
						outTransCodeName = it.searchInput;
						break;
					case 'outRouterType':
						outRouterType = it.searchInput;
						break;
					case 'modifier':
			...
			// 获取银行渠道系统表数据
			this.$http
				.post('/api/industrymanage/tongtianManage/outTransCode/list', {
					channelSystemId: channelSystemId,
					outTransCodeId: outTransCodeId,
					outTransCode: outTransCode,
					outTransCodeName: outTransCodeName,
					outRouterType: outRouterType,
					modifier: modifier,
					creator: creator,
		...
		addUriRule() {
			this.$refs.uriRuleAddContent.validate((valid) => {
				if (valid) {
					this.$http
						.post('/api/industrymanage/tongtianManage/outTransCode/add', {
							outTransCodeId: this.uriRuleAddContent.outTransCodeId,
							channelSystemId: this.uriRuleAddContent.channelSystemId,
							outTransCode: this.uriRuleAddContent.outTransCode,
							outTransCodeName: this.uriRuleAddContent.outTransCodeName,
							outRouterType: this.uriRuleAddContent.outRouterType,
		...
		updateUriRule() {
			this.$refs.uriRuleUpdateContent.validate((valid) => {
				if (valid) {
					this.$http
						.post('/api/industrymanage/tongtianManage/outTransCode/update', {
							...
							outTransCode: this.uriRuleUpdateContent.outTransCode,
							outTransCodeName: this.uriRuleUpdateContent.outTransCodeName,
							outRouterType: this.uriRuleUpdateContent.outRouterType,
		...
		updateStatus(row) {
			...
			this.$confirm('此操作影响较大, 是否继续?', '提示', {
				...
				this.$http
					.get('/api/industrymanage/tongtianManage/outTransCode/publish', {
						params: {
