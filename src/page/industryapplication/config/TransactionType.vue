<template>
	<div class="container">
		...
		<el-button
			...
			v-has3="'/industrymanage/tongtianManage/transactionType/add'"
		>
			添加
		</el-button>
		...
		>
			...
			<el-table-column prop="transTypeId" label="交易类型ID" sortable></el-table-column>
			<el-table-column prop="transTypeName" label="交易类型名称"></el-table-column>
			<el-table-column prop="routerType" label="交易发送到网关的方式" sortable></el-table-column>
			<el-table-column
				prop="originChannelSystemId"
				label="发起交易的渠道系统编号"
				sortable
			></el-table-column>
			...
			<el-table-column fixed="right" label="操作" width="170">
				<template slot-scope="scope">
					...
					<el-button
						...
						circle
						size="small"
						v-has3="'/industrymanage/tongtianManage/transactionType/publish'"
					></el-button>
					<el-button
					...
					<el-button
						...
						circle
						size="small"
						v-has3="'/industrymanage/tongtianManage/transactionType/update'"
					></el-button>
				</template>
			</el-table-column>
		</el-table>
		...
		>
			<div>
				<el-form
					...
					class="demo-ruleForm"
				>
					<el-form-item label-width="30%" label="交易类型ID" prop="transTypeId">
						<el-input
							type="text"
							v-model="uriRuleAddContent.transTypeId"
							auto-complete="off"
						></el-input>
					</el-form-item>
					<el-form-item label-width="30%" label="交易类型名称" prop="transTypeName">
						<el-input
							type="text"
							v-model="uriRuleAddContent.transTypeName"
							auto-complete="off"
						></el-input>
					</el-form-item>
					<el-form-item label-width="30%" label="交易发送到网关的方式" prop="routerType">
						<el-input
							autosize
							type="textarea"
							v-model="uriRuleAddContent.routerType"
							auto-complete="off"
						></el-input>
					</el-form-item>
					<el-form-item
					...
					>
						<el-input
							autosize
							type="textarea"
							v-model="uriRuleAddContent.originChannelSystemId"
							auto-complete="off"
						></el-input>
					</el-form-item>
			...
			<div>
				...
				>
					<el-form-item label-width="30%" label="交易类型ID" prop="transTypeId">
						<el-input
							type="text"
							v-model="uriRuleUpdateContent.transTypeId"
							auto-complete="off"
						></el-input>
					</el-form-item>
					<el-form-item label-width="30%" label="交易类型名称" prop="transTypeName">
						<el-input
							type="text"
							v-model="uriRuleUpdateContent.transTypeName"
							auto-complete="off"
						></el-input>
					</el-form-item>
					<el-form-item label-width="30%" label="交易发送到网关的方式" prop="routerType">
						<el-input
							autosize
							type="textarea"
							v-model="uriRuleUpdateContent.routerType"
							auto-complete="off"
						></el-input>
					</el-form-item>
					<el-form-item
					...
					>
						<el-input
							autosize
							type="textarea"
							v-model="uriRuleUpdateContent.originChannelSystemId"
							auto-complete="off"
						></el-input>
					</el-form-item>
					<el-form-item label-width="30%" label="备注" prop="memo">
...
export default {
	data() {
		return {
			...
			// 校验规则
			rules: {
				transTypeId: [{ required: true, message: '交易类型ID', trigger: 'blur' }],
				transTypeName: [{ required: true, message: '交易类型名称', trigger: 'blur' }],
			},
		};
	},
	watch: {},
	...
	methods: {
		...
		loadData: function () {
			...
			this.searchList.forEach((it) => {
				switch (it.searchType) {
					case 'transTypeId':
						transTypeId = it.searchInput;
						break;
					case 'transTypeName':
						transTypeName = it.searchInput;
						break;
					case 'modifier':
			...
			// 获取银行渠道系统表数据
			this.$http
				.post('/api/industrymanage/tongtianManage/transactionType/list', {
		...
		addUriRule() {
			this.$refs.uriRuleAddContent.validate((valid) => {
				if (valid) {
					this.$http
						.post('/api/industrymanage/tongtianManage/transactionType/add', {
							transTypeId: this.uriRuleAddContent.transTypeId,
							transTypeName: this.uriRuleAddContent.transTypeName,
							routerType: this.uriRuleAddContent.routerType,
							originChannelSystemId: this.uriRuleAddContent.originChannelSystemId,
		...
		updateUriRule() {
			this.$refs.uriRuleUpdateContent.validate((valid) => {
				if (valid) {
					this.$http
						.post('/api/industrymanage/tongtianManage/transactionType/update', {
							id: this.uriRuleUpdateContent.id,
							transTypeId: this.uriRuleUpdateContent.transTypeId,
							transTypeName: this.uriRuleUpdateContent.transTypeName,
							routerType: this.uriRuleUpdateContent.routerType,
							originChannelSystemId: this.uriRuleUpdateContent.originChannelSystemId,
		...
		updateStatus(row) {
			...
			this.$confirm('此操作影响较大, 是否继续?', '提示', {
				...
				this.$http
					.get('/api/industrymanage/tongtianManage/transactionType/publish', {
						params: {
