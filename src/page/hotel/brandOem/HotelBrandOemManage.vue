				...
				>
					...
					<el-table-column fixed="right" prop="operate" width="200px" label="操作">
						<template slot-scope="scope">
							<el-button
								size="mini"
								v-has3="'/hotel/brand/oem-info'"
								type="primary"
								@click="modifyBrandOemInfo(scope.row.uid)"
...
export default {
	...
	methods: {
		...
		loadData: function () {
			this.$http
				.post('/api/hotel/brand/oem-info/page', {
		...
		// 跳转品牌商OEM信息编辑界面
		modifyBrandOemInfo: function (uid) {
			this.$router.push({ name: 'hotelBrandOemModify', query: { uid: uid } });
		},
	},
};
</script>
